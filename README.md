...
### Build and Install
```
$ go get github.com/abhishekpandey003/Burrow
$ cd $GOPATH/src/github.com/abhishekpandey003/Burrow
$ gpm install
$ go install
```
...
### Configuration
For information on how to write your configuration file, check out the [detailed wiki](https://github.com/abhishekpandey003/Burrow/wiki)

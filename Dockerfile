...
MAINTAINER LinkedIn Burrow "https://github.com/abhishekpandey003/Burrow"
...
ADD . $GOPATH/src/github.com/abhishekpandey003/Burrow
RUN cd $GOPATH/src/github.com/abhishekpandey003/Burrow && gpm install && go install && mv $GOPATH/bin/Burrow $GOPATH/bin/burrow
